...
def main():
    ...
    # 重要：横坐标范围固定为 9.5-13，主刻度间隔为 1
    use_linear_x = True
    x_left, x_right = 9.5, 13
    ticks = [10, 11, 12, 13]
    ...
    plt.savefig('efficiency_pareto_ml1m.png', format='png', dpi=300, bbox_inches='tight')
    plt.savefig('efficiency_pareto_ml1m.pdf', format='pdf', dpi=300, bbox_inches='tight')
    plt.show()
