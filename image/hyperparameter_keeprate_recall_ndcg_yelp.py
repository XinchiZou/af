...
def plot_keeprate_sensitivity_dual_axis_yelp():
    """Yelp Keep rate 对 Recall/NDCG 的影响（双轴）。
    """
    ...
    # 保存
    plt.savefig('hyperparameter_keeprate_recall_ndcg_yelp.png', dpi=300, bbox_inches='tight')
    plt.savefig('hyperparameter_keeprate_recall_ndcg_yelp.pdf', dpi=300, bbox_inches='tight')
    print('File saved: hyperparameter_keeprate_recall_ndcg_yelp.png/.pdf')

    plt.show()


if __name__ == '__main__':
    plot_keeprate_sensitivity_dual_axis_yelp()
