...
def plot_temperature_sensitivity_dual_axis_mind():
    ...
    ax_left.set_xticklabels([str(int(t)) if t.is_integer() else str(t) for t in temps], fontweight='semibold', fontsize=22)
    ...
    legend_dx = 0.0
    legend_dy = 0.0
    md_ndcg_handle = Line2D([0], [0], color=color_ndcg, linestyle=(0, (1.2, 1.8)), linewidth=2.8, dash_capstyle='round')
    md_recall_handle = Line2D([0], [0], color=color_recall, linestyle=(0, (1.2, 1.8)), linewidth=2.8, dash_capstyle='round')
