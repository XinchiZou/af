...
def plot_temperature_sensitivity_dual_axis_yelp():
    """Yelp：Temperature 对 Recall/NDCG 的影响（双轴）。
    """
    ...
    ax_left.set_xticklabels([f'{t:.1f}' for t in temps], fontweight='semibold', fontsize=24)
    ...
    # 保存
    plt.savefig('hyperparameter_temp_recall_ndcg_yelp.png', dpi=300, bbox_inches='tight')
    plt.savefig('hyperparameter_temp_recall_ndcg_yelp.pdf', dpi=300, bbox_inches='tight')
    print('File saved: hyperparameter_temp_recall_ndcg_yelp.png/.pdf')
...
if __name__ == '__main__':
    plot_temperature_sensitivity_dual_axis_yelp()
